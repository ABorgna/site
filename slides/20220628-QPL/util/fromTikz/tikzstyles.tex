...
%lias asd='setxkbmap us dvp -option "ctrl:nocaps,compose:ralt"; xdotool key Caps_Lock' \tikzstyle{ddot}=[inner sep=0.6mm, double=white, very thick, double distance=1pt, minimum width=2.5mm,minimum height=2.5mm,draw,shape=circle]
...
\tikzstyle{small dot}=[inner sep=1pt,minimum width=0pt,minimum height=0pt,draw,shape=circle]
...
% ========================
 ...
 \tikzstyle{upground}=[circuit ee IEC,thick,ground,rotate=90,scale=1.0]
 \tikzstyle{downground}=[circuit ee IEC,thick,ground,rotate=-90,scale=1.0]
